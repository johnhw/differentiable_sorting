...
def dsort(matrices, x, softmax=softmax):
    """
...
def diff_bisort(matrices, x, alpha=1.0):
    ...
    a sequence x of length n. Values may be distorted slightly but will be ordered.
    """
    return dsort(matrices, x, lambda a, b: softmax(a, b, alpha=alpha))
...
def smoothmax_bisort(matrices, x, alpha=1):
    ...
    """
    return dsort(matrices, x, lambda a, b: smoothmax(a, b, alpha=alpha))
...
def dsort_weave(matrices, x, softmax=softmax):
    """
...
def diff_bisort_smooth(matrices, x, smooth=0):
    ...
    """
    return dsort(matrices, x, lambda a, b: softmax_smooth(a, b, smooth=smooth))
